...
public class ExtentReortManager  implements ITestListener
{
	...
	{		
		...
		sparkReporter=new ExtentSparkReporter(System.getProperty("user.dir")+ "/reports/demo.Opencart.html" +repName );
		...
		extent.setSystemInfo("user","Kadiyala");
	}
	...
	//If the test fails it will capture the screenshot for the failure page and return it in the extent reports
